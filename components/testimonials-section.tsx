      ...
      <div className="container px-4 md:px-6">
        ...
        >
          {[...Array(3)].map((_, index) => (
            <Card
              key={index}
              className="min-w-[300px] md:min-w-[400px] bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-800 
                         overflow-hidden group hover:shadow-lg hover:shadow-blue-900/20 transition-all duration-300 ease-in-out hover:-translate-y-2"
            >
              ...
              <CardFooter className="flex items-center gap-4 p-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">CEO, Global Logistics Ltd.</p>
                </div>
              </CardFooter>
            </Card>
          ))}
